export const ProjectsCollection = [
  ...
  { name: 'Landing Page', path: '/landing-page', description: '' },
  { name: 'Dashboard', path: '/dashboard', description: '' },
  { name: 'CMS', path: '/cms', description: '' },
  { name: 'Chat Application', path: '/chat-app', description: '' },
];